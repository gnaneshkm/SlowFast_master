...
# Path to the checkpoint to load the initial weight.
_C.TEST.CHECKPOINT_FILE_PATH = "/home/gnk/ava_weights/cb_loss/checkpoints/checkpoint_epoch_00190.pyth"
...
_C.TEST.SAVE_RESULTS_PATH = "/home/gnk/ava2/predictions/"
# -----------------------------------------------------------------------------
# ResNet options
# -----------------------------------------------------------------------------
_C.RESNET = CfgNode()
...
_C.DATA.PATH_TO_DATA_DIR = "/home/gnk/data/ava/"
...
# Output basedir.
_C.OUTPUT_DIR = "/home/gnk/ava2/results"
...
_C.AVA.FRAME_DIR = "/mnt/dst_datasets/own_omni_dataset/theodore_v3/images"

# Directory path for files of frame lists.
_C.AVA.FRAME_LIST_DIR = (
   "/home/gnk/verified_data/frame_lists"
)

# Directory path for annotation files.
_C.AVA.ANNOTATION_DIR = (
    "/home/gnk/verified_data/annotations"
)

# Filenames of training samples list files.
_C.AVA.TRAIN_LISTS = ["tr_file.csv"]

# Filenames of test samples list files.
_C.AVA.TEST_LISTS = ["test_file.csv"]

# Filenames of box list files for training. Note that we assume files which
# contains predicted boxes will have a suffix "predicted_boxes" in the
# filename.
_C.AVA.TRAIN_GT_BOX_LISTS = ["train_ver.csv"]
...
_C.AVA.LABEL_MAP_FILE = "action_list.pbtxt"

# The name of the file to the ava exclusion.
_C.AVA.EXCLUSION_FILE = ""

# The name of the file to the ava groundtruth.
_C.AVA.GROUNDTRUTH_FILE ="test_ver.csv"
...
_C.TENSORBOARD.PREDICTIONS_PATH = "/home/gnk/ava2/predictions/"
# Path to directory for tensorboard logs.
# Default to to cfg.OUTPUT_DIR/runs-{cfg.TRAIN.DATASET}.
_C.TENSORBOARD.LOG_DIR = "/home/gnk/ava_weights/cb_loss/out"
# Path to a json file providing class_name - id mapping
# in the format {"class_name1": id1, "class_name2": id2, ...}.
# This file must be provided to enable plotting confusion matrix
# by a subset or parent categories.
_C.TENSORBOARD.CLASS_NAMES_PATH = "/home/gnk/data_ava/data/ava/annotations/AVA_classnames.json"
...
# Path to a json file providing class_name - id mapping
# in the format {"class_name1": id1, "class_name2": id2, ...}.
_C.DEMO.LABEL_FILE_PATH = "/home/gnk/data_ava/data/ava/annotations/AVA_classnames.json"
...
_C.DEMO.INPUT_VIDEO = "/home/gnk/data_ava/data/ava/test/test.mp4"
...
_C.DEMO.PREDS_BOXES = "/home/gnk/new/annotaions/val_sample.csv"
