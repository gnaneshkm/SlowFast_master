...
class Ava(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        import pickle
        with open('/home/gnk/ava2/results/imgs.pkl', 'wb') as f:
            pickle.dump(imgs, f)
        with open('/home/gnk/ava2/results/boxes.pkl', 'wb') as f:
            pickle.dump(boxes, f)
        with open('/home/gnk/ava2/results/imgs_paths.pkl', 'wb') as f:
