...
def get_keyframe_data(boxes_and_labels):
    ...
    with open('/home/gnk/data/keyframe_index.pkl', 'wb') as f:
        pickle.dump(keyframe_indices, f)
    with open('/home/gnk/data/keyframe_indices_lab.pkl', 'wb') as f:
        pickle.dump(keyframe_boxes_and_labels, f)
